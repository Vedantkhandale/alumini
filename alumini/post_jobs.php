...
if(isset($_POST['post'])){
    ...
    $sql = "INSERT INTO jobs (alumni_id, title, company, designation, location, vacancy, description, status) 

            VALUES ('$alumni_id', '$title', '$company', '$designation', '$loc', '$vacancy', '$desc', 'pending')";
    ...
    <form method="POST">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
            ...
            <div>
                ...
                <input type="text" name="designation" placeholder="SDE / Manager" required>
        ...
        <input type="text" name="vacancy" placeholder="Number of openings" required>
